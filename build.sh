...
#dotnet test ./test/ArrayOfBytes.OAuth.Client.Tests -c Release -f netcoreapp1.0
...
dotnet pack ./src/ArrayOfBytes.BirdBranch -c Release -o ./artifacts --version-suffix=$revision  